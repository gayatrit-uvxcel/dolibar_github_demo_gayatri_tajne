...
// Price HT
print '<th class="linecoluht right nowraponall">' . $langs->trans('Per') . '</th>';
...
if (!empty($inputalsopricewithtax) && !getDolGlobalInt('MAIN_NO_INPUT_PRICE_WITH_TAX')) {
	print '<th class="right nowraponall">' . $langs->trans('Per(inc. tax)') . '</th>';
}
...
// unit 
print '<th class="linecoluseunit right">' . $langs->trans('Unit') . '</th>';

// Total HT
print '<th class="linecolht right">' . $langs->trans('Price') . '</th>';
