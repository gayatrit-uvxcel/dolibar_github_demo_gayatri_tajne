	...
	if ($pictoisfullpath) {
		...
		if (empty($srconly) && in_array($pictowithouttext, array(
			...
			$arrayconvpictotofa = array(
				'account'=>'university', 'accounting_account'=>'clipboard-list', 'accountline'=>'receipt', 'accountancy'=>'search-dollar', 'action'=>'calendar-alt', 'add'=>'plus-circle', 'address'=> 'address-book', 'asset'=>'money-check', 'autofill'=>'fill',
				'bank_account'=>'university',
				'bill'=>'file-invoice', 'billa'=>'file-excel', 'billr'=>'file-invoice', 'billd'=>'file-medical',
				'supplier_invoice'=>'file-invoice', 'supplier_invoicea'=>'file-excel', 'supplier_invoicer'=>'file-invoice', 'supplier_invoiced'=>'file-medical',
				'bom'=>'shapes',
				...
				'intervention'=>'ambulance', 'invoice'=>'file-invoice', 'currency'=>'registered', 'multicurrency'=>'registered', 'order'=>'file-invoice',
				...
				'partnership'=>'handshake', 'payment'=>'money-check', 'payment_vat'=>'money-check', 'pictoconfirm'=>'check-square', 'phoning'=>'phone', 'phoning_mobile'=>'mobile-alt', 'phoning_fax'=>'fax', 'previous'=>'arrow-alt-circle-left', 'printer'=>'print', 'product'=>'cube', 'puce'=>'angle-right',
				...
				'timespent'=>'clock', 'title_setup'=>'tools', 'title_accountancy'=>'money-check', 'title_bank'=>'university', 'title_hrm'=>'umbrella-beach',
				'title_agenda'=>'calendar-alt',
				'uncheck'=>'times', 'uparrow'=>'share', 'url'=>'external-link-alt', 'vat'=>'money-check', 'vcard'=>'arrow-alt-circle-down',
				'jabber'=>'comment-o',
			...
			$arrayconvpictotocolor = array(
				'address'=>'#6D6845', 'building'=>'#6D6845', 'bom'=>'#a69944',
				'clone'=>'#999', 'cog'=>'#999', 'companies'=>'#6D6845', 'company'=>'#6D6845', 'contact'=>'#6D6845', 'cron'=>'#555',
				'dynamicprice'=>'#a69944',
				...
				'partnership'=>'#6D6845', 'playdisabled'=>'#ccc', 'printer'=>'#444', 'projectpub'=>'#986c6a', 'reception'=>'#a69944', 'resize'=>'#444', 'rss'=>'#cba',
				//'shipment'=>'#a69944',
...
function load_fiche_titre($titre, $morehtmlright = '', $picto = 'generic', $pictoisfullpath = 0, $id = '', $morecssontable = '', $morehtmlcenter = '')
{
	...
	if ($titre === "New commercial proposal") {
        $return .= '<div class="titre inline-block">Quotation</div>';
    } else {
        $return .= '<div class="titre inline-block">'.$titre.'</div>';
    }
	$return .= '</td>';
	...
	if (dol_strlen($morehtmlright)) {
		$return .= '<td class="nobordernopadding titre_right wordbreakimp right valignmiddle col-right" style="display:none">'.$morehtmlright.'</td>';
	}
	$return .= '</tr></table>'."\n";
